    ...
    passport.use(
        ...
        new LocalStrategy({
            ...
            connection.query('SELECT * FROM users WHERE username = ?', [username], (err, rows) => {
                ...
                if (!bcrypt.compareSync(password, rows[0].password)) return done(null, false, req.flash('loginMessage', 'No user found.')); // create the loginMessage and save it to session as flashdata
