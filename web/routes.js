...
It also connects to the database, and handels logging into the admin page currently.

*/

const mysql = require('mysql');
const config = require('../opt/config.json');
const connection = mysql.createConnection(config.webserver.database);
connection.query(`USE ${config.webserver.database.dbname}`);

module.exports = (app, passport) => {
  //  "Register" all of our api links
  // require('./routes/api/globalSettings.js')(app, passport, connection);
  // require('./routes/api/mapAccounts.js')(app, passport, connection);
  ...
  // require('./routes/api/auth.js')(app, passport, connection);
  require("./routes/api/log.js")(app, passport, connection);
  ...
  //admin profile. TO BE CHANGED
  app.get("/log", isLoggedIn, ({ user }, res) => {
